...
exports.getUser = (req, res, next) => {
  ...
  const select =
    "rootUser.role rootUser.permissions wallet.rootUser wallet.relatedUser wallet.userType streams giftHistory"
...
exports.getUsers = (req, res, next) => {
  ...
  const qry = {}
  paginator.withNormal(Viewer, qry, select, req, res).catch((err) => next(err))
}
