exports.checkForViewer = (req, res, next) => {
    ...
    const permissions = ["read-user","update-user","delete-user","read-wallet","read-model","read-stream","read-giftpurchase","create-giftpurchase","read-coinpurchase","create-coinpurchase","read-gifts"]
